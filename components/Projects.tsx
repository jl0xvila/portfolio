...
function Projects({ projects }: Props) {
    ...
    >
        ...
        snap-mandatory z-20 scrollbar scrollbar-track-gray-400/20 scrollbar-thumb-[#6a8f54]'>
                ...
                justify-center p-20 md:p-44 h-screen'>
                    ...
                    <div className='space-y-10 px-0 md:px-10 max-w-6xl'>
                        <h4 className='text-4xl font-semibold text-center'>
                            <span className='underline decoration-[#6a8f54]/70'>
        ...
        <div className='w-full absolute top-[30%] bg-[#6a8f54]/10 left-0 h-[500px] -skew-y-12'>
